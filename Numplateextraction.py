...
#Resize and gray scaling and dge detection
img = cv2.imread('tiiis.jpg',cv2.IMREAD_COLOR)#insert file and image name
...
#convert the gray scale image to real image
Cropped = img[topx:bottomx+1, topy:bottomy+1]
imgplot= plt.imshow(Cropped)
plt.show()


#store the image as a png formate
